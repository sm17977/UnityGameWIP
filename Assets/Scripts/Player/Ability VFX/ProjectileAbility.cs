...
public abstract class ProjectileAbility : MonoBehaviour {
    ...
    public void InitProjectileProperties(Vector3 direction, Vector3 targetPos, Ability abilityData, List<GameObject> projectileList, PlayerType type, LuxPlayerController playerScript) {
