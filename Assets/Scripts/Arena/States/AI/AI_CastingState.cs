...
public class AI_CastingState : State
{
    ...
    public AI_CastingState (Lux_AI_Controller controller,  GameObject gameObject, Ability ability){
        agent = controller;
        player = gameObject;
    ...
    public override void Execute() {
        ...
        if (agent.canCast) {
            ...
            // Create projectile
            GameObject newProjectile = Lux_AI_Controller.Instantiate(ability.missile, abilitySpawnPos,  Quaternion.LookRotation(direction, Vector3.up));
